...
menu.append("div").append("img").attr("src", new URL(require("ff1b43c28d621721")).href).attr("id", "prize-reload-button").on("click", ()=>{
    (0, _uiFunctions.clearResults)();
    (0, _uiFunctions.newChallenge)();
    // window.seniorMode ? newChallenge() : newJuniorPrize();
    (0, _uiFunctions.makeWallet)();
});
...
},{}],"4pqgd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./array.js":"9WejU","./selection/index.js":"fK3Dl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8WT3G":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeWallet", ()=>makeWallet);
parcelHelpers.export(exports, "newChallenge", ()=>newChallenge);
...
function newChallenge() {
    // Set price
    window.price = Math.floor(window.currentMode.priceInterval[0] + Math.random() * (window.currentMode.priceInterval[1] - window.currentMode.priceInterval[0] + 1));
    // Set prize image
    window.prizeImg = (0, _prizes.prizesImgs)[Math.floor(Math.random() * (0, _prizes.prizesImgs).length)];
    _d3Selection.select("#prize").select("img").attr("src", window.prizeImg);
...
parcelHelpers.export(exports, "juniorPrizes", ()=>juniorPrizes);
const prizesImgs = [
    new URL(require("8bdb8956d5c59cc7")).href,
    new URL(require("63322bfd081e8976")).href,
    new URL(require("90bd51215f9add78")).href,
    new URL(require("5b612237b288abab")).href,
    new URL(require("e783b48f7dcbc10c")).href,
    new URL(require("3d30357b04f3ca23")).href,
    new URL(require("642541307cfa3f39")).href,
    new URL(require("8f1d4d7c84300c4d")).href,
    new URL(require("7bffa4d0a83ed4f3")).href,
    new URL(require("32fc3ba4da69e26c")).href,
    new URL(require("148b2c5eef7a51fa")).href,
    new URL(require("cbc0efd0ba30dfa8")).href,
    new URL(require("aeea4ccc3d451e3e")).href
];
const juniorPrizes = [
    {
...
},{"fb928f6ce4f5749b":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"7kCtN":[function(require,module,exports) {
...
},{"4632bb5ad41ddd38":"lgJ39"}],"kh34X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _d3Selection = require("d3-selection");
...
const d3 = {
    ...
    transition: (0, _d3Transition.transition),
    local: (0, _d3Selection.local),
    svg: (0, _d3Fetch.svg)
};
async function loadCoinArt(parent, value) {
    const newsvg = await d3.svg(new URL(require("79b1ae6d2b019b9b")).href);
...
class wallet {
    constructor(radix, numPockets){
        this.radix = radix;
        this.pockets = new Array(numPockets).fill(0);
        // this.setPocket(0, 143);
        this.createUI(document.getElementById("wallet-container"));
        this.fillPocketsUI();
    }
    setPocket(index, x) {
    ...
    explode(index) {
        if (index >= this.pockets.length) return;
    ...
    value() {
        return this.pockets.reduce((acc, curr, i)=>acc + curr * Math.pow(this.radix, i), 0);
    }
    createUI(container) {
        ...
        pocketsList.forEach((d, i)=>{
            itemsList.push(d);
            if (i < pocketsList.length - 1) itemsList.push({
                type: "expControls",
                pocketIndex: i
            });
        });
    ...
    unexplodeAnimation() {
        ...
        newCoins.each((d, i, n)=>{
            ...
            clone.classList.add("choose");
            document.getElementById("animation-container")?.appendChild(clone);
            finalPositions.set(clone, n[i].getBoundingClientRect());
        });
    ...
    checkStatus() {
        if (!window.seniorMode) {
            ...
            if (this.checkGoalReached()) {
                this.goalReached();
                if (this.checkDecomposed()) this.decomposed();
            }
        } else // senior
        if (this.checkGoalReached()) {
            d3.select("#walletValue-img").classed("goal-reached", true);
            if (this.checkDecomposed()) this.decomposed();
        } else d3.select("#walletValue-img").classed("goal-reached", false);
    }
    ...
    checkDecomposed() {
        const goalValues = this.value().toString(this.radix).split("").map((d)=>parseInt(d, this.radix)).reverse();
        const padding = this.pockets.length - goalValues.length;
        for(let k = 0; k < padding; k += 1)goalValues.push(0);
...
},{"./blob.js":false,"./buffer.js":false,"./dsv.js":false,"./image.js":false,"./json.js":false,"./text.js":false,"./xml.js":"kdoqs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gA1Rh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./text.js":"gA1Rh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g3trs":[function(require,module,exports) {
module.exports = require("a3c735405767f782").getBundleURL("1e3qO") + "coin-num.1edeccb9.svg" + "?" + Date.now();

},{"a3c735405767f782":"lgJ39"}],"41n9L":[function(require,module,exports) {
module.exports = require("f19665fab79788a0").getBundleURL("1e3qO") + "bag.a1b71791.svg" + "?" + Date.now();

},{"f19665fab79788a0":"lgJ39"}],"2cGd6":[function(require,module,exports) {
module.exports = require("45cda1789e5022f4").getBundleURL("1e3qO") + "minus.b53a752f.png" + "?" + Date.now();

},{"45cda1789e5022f4":"lgJ39"}],"kemYm":[function(require,module,exports) {
module.exports = require("3ddbd6acb0d012de").getBundleURL("1e3qO") + "plus.21c0cfed.png" + "?" + Date.now();

},{"3ddbd6acb0d012de":"lgJ39"}],"heaRa":[function(require,module,exports) {
module.exports = require("9048ed87acb6bdd4").getBundleURL("1e3qO") + "left.5cb09e67.png" + "?" + Date.now();
...
const levelIcons = {
    level1: new URL(require("15c99931a7878a61")).href,
    level2: new URL(require("3ad8215c508596a5")).href,
    level3: new URL(require("27c78dd6f5b0bead")).href,
    level4: new URL(require("9659bbdb1c035f9d")).href,
    level5: new URL(require("276a45cf553ffd01")).href,
    level6: new URL(require("c7fb0c9593fcda5f")).href
};

},{"15c99931a7878a61":"2xzBD","3ad8215c508596a5":"kk5eI","27c78dd6f5b0bead":"kgXg1","9659bbdb1c035f9d":"erQwY","276a45cf553ffd01":"7H9VM","c7fb0c9593fcda5f":"7j2zI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2xzBD":[function(require,module,exports) {
module.exports = require("173f9c3f754be131").getBundleURL("1e3qO") + "coin-level-1.d16a22f0.png" + "?" + Date.now();

},{"173f9c3f754be131":"lgJ39"}],"kk5eI":[function(require,module,exports) {
module.exports = require("2a64cfc7b8d07710").getBundleURL("1e3qO") + "coin-level-2.59ddec14.png" + "?" + Date.now();

},{"2a64cfc7b8d07710":"lgJ39"}],"kgXg1":[function(require,module,exports) {
module.exports = require("96a7b0b8f6d0dfca").getBundleURL("1e3qO") + "coin-level-3.20274148.png" + "?" + Date.now();

},{"96a7b0b8f6d0dfca":"lgJ39"}],"erQwY":[function(require,module,exports) {
module.exports = require("e213011f50bdc1c0").getBundleURL("1e3qO") + "coin-level-4.0982c4ca.png" + "?" + Date.now();

},{"e213011f50bdc1c0":"lgJ39"}],"7H9VM":[function(require,module,exports) {
module.exports = require("18f06218c0e16bd3").getBundleURL("1e3qO") + "coin-level-5.1471a6ee.png" + "?" + Date.now();
...
},{"de50568d82e146b0":"lgJ39"}],"cjPvE":[function(require,module,exports) {
module.exports = require("679ba9c2bce1797c").getBundleURL("1e3qO") + "forward.a495d943.png" + "?" + Date.now();

},{"679ba9c2bce1797c":"lgJ39"}],"2t12F":[function(require,module,exports) {
