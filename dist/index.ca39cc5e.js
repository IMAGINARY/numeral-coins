...
class wallet {
    ...
    fillPocketsUI() {
        ...
        if (this.checkGoal()) {
            this.goalReached();
            if (this.checkDecomposed()) this.decompositionFound();
        }
    }
    explodeAnimation() {
        const coinsLists = this.pockets.map((d)=>new Array(d).fill(0).map((d, i)=>i));
...
},{"./array.js":"9WejU","./selection/index.js":"fK3Dl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4lorl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"a3c735405767f782":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"41n9L":[function(require,module,exports) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "prizes", ()=>prizes);
const prizes = [
    {
